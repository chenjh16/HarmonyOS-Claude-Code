...
> **Note**: This report documents historical tests conducted with the `anyrouter` Claude API proxy.
> The current setup uses LiteLLM proxy (`http://<your-litellm-host>:<port>`) with GLM-5/Qwen3.6-Plus models.
...
| **Claude Code Version** | 2.1.88-ohos.1 |
| **Model** | claude-opus-4-6[1m] (Opus 4.6 1M context) |
| **API Proxy** | https://a-ocnfniawgw.cn-shanghai.fcapp.run (historical, now using LiteLLM) |
...
*Claude Code 2.1.88-ohos.1 (Claude Opus 4.6 1M context)*
