...
> **注意**：本报告记录的是使用 `anyrouter` Claude API 代理进行的历史测试。
> 当前已切换为 LiteLLM 代理（`http://<your-litellm-host>:<port>`），使用 GLM-5/Qwen3.6-Plus 模型。
...
| **Node 版本** | v24.13.0 |
| **Claude Code 版本** | 2.1.88-ohos.1 |
| **模型** | claude-opus-4-6[1m]（Opus 4.6 1M 上下文）|
| **API 代理** | https://a-ocnfniawgw.cn-shanghai.fcapp.run（历史记录，现已使用 LiteLLM）|
