...
// Copy .env.example (installed to ~/.claude/.env.example by postinstall)
const envExampleSrc = path.join(projectRoot, ".env.example")
if (fs.existsSync(envExampleSrc)) {
  fs.copyFileSync(envExampleSrc, path.join(outDir, ".env.example"))
}
...
const npmPkg = {
  ...
  main: "./cli.js",
  files: ["cli.js", "bin/", "postinstall-rg.mjs", "start-claude.sh", ".env.example"],
  scripts: {
