...
try {
  ...
  if (existsSync(templateSrc)) {
    ...
    if (!existsSync(templateDest)) {
      ...
      console.log(``)
      console.log(`  ┌─────────────────────────────────────────────────────────┐`)
      console.log(`  │  Next: edit ~/.claude/start-claude.sh to configure     │`)
      console.log(`  │  your API endpoint and credentials, then run:          │`)
      console.log(`  │                                                        │`)
      console.log(`  │    export ANTHROPIC_AUTH_TOKEN="your-token-here"        │`)
